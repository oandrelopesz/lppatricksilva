...
16. **Riscos residuais de LGPD (pareceres R36 e R37), para a revisão jurídica:** base legal dos sinais sem cookies do modo avançado (legítimo interesse, art. 7º, IX, escolhido pelo André; a ANPD não aceita legítimo interesse para dado sensível, e a visita a uma LP médica pode ser inferência de saúde); contratos, países, mecanismo de transferência e retenção reais de Google, Meta e Vercel; dispensa de encarregado (Resolução CD/ANPD 2/2022) ou publicação do contato; mapas do Google carregados sem consentimento (decisão do André; a política informa); valores de parâmetros com nome permitido (gclid e afins) não são verificados como opacos; papéis das clínicas no agendamento.
