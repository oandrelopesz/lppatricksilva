...
const SECOES: Array<[string, string]> = [
  ["1. Sobre esta página", "Esta página apresenta o atendimento particular do Dr. Patrick Santos, ortopedista, nas cidades do Maranhão onde ele atende, e permite começar uma conversa pelo WhatsApp para agendar uma consulta. Ao usar a página, você concorda com estes termos."],
  ...
  ["3. Agendamento", "O agendamento é feito pelo WhatsApp (13) 99682-2680, com o próprio Dr. Patrick Santos. O atendimento é exclusivamente particular: não atende plano de saúde nem SUS. A disponibilidade de datas e horários é combinada na conversa, e a consulta só fica marcada depois da confirmação por lá."],
  ...
  ["6. Direitos sobre o conteúdo", "Os textos, as fotos e as ilustrações desta página pertencem ao Dr. Patrick Santos ou são usados com autorização, e não podem ser copiados sem permissão."],
