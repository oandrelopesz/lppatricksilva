...
export function S2Hero() {
  return (
    <header className="premium-texture bg-creme px-4 pb-16 pt-8 text-grafite md:py-20">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-x-16 gap-y-6 md:grid-cols-2 md:items-start">
        <div className="min-w-0">
          ...
          <h1 className="max-w-xl text-[clamp(2.05rem,5vw,3.8rem)] font-bold leading-[1.08] tracking-tight">
            {T.headline}
          </h1>
          <p className="mt-5 max-w-xl text-lg leading-normal">{T.subheadline}</p>
          <p className="mt-4 flex max-w-xl items-start gap-2 text-base leading-snug">
